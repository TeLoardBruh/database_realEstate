  ...
  <body>
    ...
    <div class="page">
                    ...
                    <div class="rd-navbar-main-outer">
                            <div class="rd-navbar-main">
                                ...
                                <div class="rd-navbar-panel">
                                    ...
                                    <!-- RD Navbar Brand-->
                                    <div class="rd-navbar-brand"><a class="brand" href="index.html"><img src="{{asset('images/logo_k.png')}}" alt="" width="229" height="40" /></a></div>
                                </div>
      ...
      <section class="section section-fluid">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15633.8221280465!2d104.89514592758218!3d11.590836768351767!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3109517bf7757d23%3A0x965c34888684bf1!2sParagon%20International%20University!5e0!3m2!1sen!2skh!4v1581232327545!5m2!1sen!2skh" width="100%" height="600" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
        </div>
      </section>
            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <p class="box-contacts-link"><a href="tel:#">+855 12-345-678</a></p>
                  <p class="box-contacts-link"><a href="tel:#">+855 12-876-543</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="#">អាគារលេខ ៨, សង្កាត់បឹងកក់១, St 315, Phnom Penh</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="mailto:#">RealEstateAgent@KMJ.kh.org</a></p>
                  <p class="box-contacts-link"><a href="mailto:#">info@KMJ.kh.org</a></p>
                </div>
              </article>
            </div>
          </div>
                ...
                <div class="contact-classic">
                  <div class="contact-classic-item">
                    <div class="unit align-items-center">
                      ...
                      <div class="unit-body contact-classic-link"><a href="#">អាគារលេខ ៨, សង្កាត់បឹងកក់១, St 315, Phnom Penh</a></div>
                    </div>
                  </div>
                  <div class="contact-classic-item">
                    <div class="unit align-items-center">
                      ...
                      <div class="unit-body contact-classic-link"><a href="tel:#">+855 12-345-678</a>, <a href="tel:#"> +855 12-876-543</a>
                      </div>
                    </div>
                  </div>
                  <div class="contact-classic-item">
                    <div class="unit align-items-center">
                      ...
                      <div class="unit-body contact-classic-link"><a href="mailto:#">info@KMJ.kh.org</a>, <a href="mailto:#"> RealEstateAgent@KMJ.kh.org</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-10 col-lg-6 col-xl-4 wow fadeInRight" data-wow-delay=".2s">
              <div class="box-footer">
                ...
                <ul class="footer-list-category">
                  <li class="heading-5"><a href="#">Home<span></span></a></li>
                  <li class="heading-5"><a href="#">Land<span></span></a></li>
                  <li class="heading-5"><a href="#">Condominium<span></span></a></li>
                  <li class="heading-5"><a href="#">Consultations<span></span></a></li>
                  <li class="heading-5"><a href="#">Commercial<span></span></a></li>
                </ul>
              </div>
            </div>
          </div>
